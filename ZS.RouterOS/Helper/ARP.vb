...
#Region "脚本"
        ...
        ''' <returns></returns>
        Public Shared Function ARP_ScriptText_Add(ByVal model As ARP_Model) As String
        ...
        ''' <param name="ip"></param>
        ''' <returns></returns>
        Public Shared Function ARP_ScriptText_RemoveByIPAddress(ByVal ip As String) As String
        ...
        ''' <returns></returns>
        Public Shared Function ARP_ScriptText_RemoveByMacAddress(ByVal mac As String) As String
